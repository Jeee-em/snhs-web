              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="font-semibold text-gray-900 line-clamp-1 mb-2">
                    {highlightText(post.title || 'Untitled', query) as React.ReactNode}
                  </h3>

                  <p className="text-sm text-gray-600 line-clamp-2 mb-2">
                    {highlightText(post.excerpt || '', query) as React.ReactNode}
                  </p>
                  ...
                  <div className="flex items-center gap-4 text-xs text-gray-500">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{String(formatDate(post.publishedAt))}</span>
                    </div>
